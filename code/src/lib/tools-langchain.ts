...
export const createReminderTool = tool(
  async (input: z.infer<typeof createReminderSchema>) => {
...
export const listRemindersTool = tool(
  async (input: z.infer<typeof listRemindersSchema>) => {
...
export const completeReminderTool = tool(
  async (input: z.infer<typeof completeReminderSchema>) => {
...
export const getWeatherTool = tool(
  async (input: z.infer<typeof getWeatherSchema>) => JSON.stringify(await coreGetWeather(input)),
  {
    name: 'get_weather',
